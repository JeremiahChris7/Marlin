...
#define PID_MAX 60 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.7562,79.7562,1600,107.0}  // default steps per unit
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {500,500,100,10000}    // X, Y, Z, E maximum start speed
